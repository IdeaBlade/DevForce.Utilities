...
xcopy /i/y DevForceLINQPadDriver.dll "C:\ProgramData\LINQPad\Drivers\DataContext\4.0\DevForceLINQPadDriver (7e7bc232eb1cb80f)\"
xcopy /i/y DevForceLINQPadDriver.pdb "C:\ProgramData\LINQPad\Drivers\DataContext\4.0\DevForceLINQPadDriver (7e7bc232eb1cb80f)\"
